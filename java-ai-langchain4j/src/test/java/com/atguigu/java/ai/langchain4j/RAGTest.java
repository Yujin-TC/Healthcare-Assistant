...
public class RAGTest {
    ...
    //并使用默认的文档解析器TextDocumentParser对文档进行解析
        //Document document = FileSystemDocumentLoader.loadDocument("测试.txt");
        //System.out.println(document.text());

        // 加载单个文档
        //Document document = FileSystemDocumentLoader.loadDocument("knowledge/file.txt", new TextDocumentParser());

// 从一个目录中加载所有文档
        //List<Document> documents = FileSystemDocumentLoader.loadDocuments("knowledge", new TextDocumentParser());

// 从一个目录中加载所有的.txt文档
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.md");
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("knowledge", pathMatcher, new TextDocumentParser());
...
// 从一个目录及其子目录中加载所有文档
        //List<Document> documents = FileSystemDocumentLoader.loadDocumentsRecursively("knowledge", TextDocumentParser());
    }
    /**
     * 解析PDF
     */
...
//计算 token 长度
        //QwenTokenizer tokenizer = new QwenTokenizer("sk-4c65682effb048fc8911861f2330104b","qwen-max");
